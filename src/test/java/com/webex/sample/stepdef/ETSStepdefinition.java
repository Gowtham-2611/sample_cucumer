...
public class ETSStepdefinition {
	...
	// StartDate ---(//input[contains(@id,'mat-checkbox-')])[4] -- tags insoide
	// checkbox
	...
	public static void verify_Startdate(String Startdate) {
		...
		Startdate = DriverManager.getDriver()
				.findElement(By
	...
	public void user_verify_Enddate_populated_as(String Enddate) throws Throwable {
		...
		String actualEnddate = DriverManager.getDriver()
				.findElement(By
						.xpath("(//mat-label[text()='End Date']/preceding::input[@class='ng-untouched ng-pristine ng-valid'])[2]"))
				.getAttribute("value");
	...
	public static void user_verify_CCY_option_as(String arg1) {
		String ccyActual = DriverManager.getDriver()
				.findElement(By.xpath("//mat-select[@formcontrolname='ccy']/child::div['mat-select-trigger']"))
				.getText();
	...
	public static void user_verfiy_Rate_info_index(String arg1) {
		DriverManager.getDriver()
				.findElement(By.xpath("//mat-select[@formcontrolname='index']/child::div['mat-select-trigger']"))
				.getText();
	...
	public static void user_verify_Rate_info(String arg1) {
		DriverManager.getDriver()
				.findElement(By.xpath("//mat-select[@formcontrolname='tenor']/child::div['mat-select-trigger']"))
				.getText();
	...
	public static void user_Rate_info_Actual_Frequency(String arg1) {
		DriverManager.getDriver()
				.findElement(By.xpath("//mat-select[@formcontrolname='accrueFreq']/child::div['mat-select-trigger']"))
				.getText();
	...
	public static void user_verify_Rate_info_Calender_option(String arg1) {
		DriverManager.getDriver()
				.findElement(By
						.xpath("//mat-select[@formcontrolname='accrueCalendarList']/child::div['mat-select-trigger']"))
				.getText();
	...
	public void user_verify_Rate_info_Day_Count_Dropdown_is_populated_as(String arg1) {
		DriverManager.getDriver()
				.findElement(By.xpath("//mat-select[@formcontrolname='dayCount']/child::div['mat-select-trigger']"))
				.getText();
	...
	public void user_verify_Rate_Info_Day_Dropdown_is_populated_as(String arg1) {
		DriverManager.getDriver()
				.findElement(
						By.xpath("//mat-select[@formcontrolname='accrueEndOfMonth']/child::div['mat-select-trigger']"))
				.getText();
	...
	public void user_verify_Payment_Info_Day_Dropdown_is_populated_as(String arg1) {
		DriverManager.getDriver()
				.findElement(By.xpath("//mat-select[@formcontrolname='paymentFreq']/child::div['mat-select-trigger']"))
				.getText();
		System.out.println("Monthly");
	}
	...
	public void user_verify_payment_info_Calendar_option_Dropdown_is_populated_as(String arg1) {
		DriverManager.getDriver()
				.findElement(By
						.xpath("//mat-select[@formcontrolname='paymentCalendarList']/child::div['mat-select-trigger']"))
				.getText();
		System.out.println("NYC");
	}
	...
	public void user_verify_payment_info_Day_Count_Dropdown_is_populated_as(String arg1) {
		DriverManager.getDriver()
				.findElement(
						By.xpath("//mat-select[@formcontrolname='paymentEndOfMonth']/child::div['mat-select-trigger']"))
				.getText();
		System.out.println("Day");
	}
	...
	public void user_verify_payment_info_Roll_Rule_option_Dropdown_is_populated_as(String arg1) {
		DriverManager.getDriver()
				.findElement(By.xpath("//mat-select[@formcontrolname='rollRule']/child::div['mat-select-trigger']"))
				.getText();
	...
	public void user_verify_payment_info_Business_day_Dropdown_is_populated_as(String arg1) {
		DriverManager.getDriver()
				.findElement(By.xpath("//mat-select[@formcontrolname='adjBusDay']/child::div['mat-select-trigger']"))
				.getText();
	...
	public void user_verify_payment_info_first_payment_populated_as(String arg1) {
		String firstPayementDate = DriverManager.getDriver()
				.findElement(By
						.xpath("(//mat-label[text()='First payment']/preceding::input[@class='ng-untouched ng-pristine ng-valid'])[3]"))
				.getAttribute("value");
	...
	public void user_verify_payment_info_Last_payment_populated_as(String arg1) throws Throwable {
		String lastPaymentDate = DriverManager.getDriver()
				.findElement(By
						.xpath("(//mat-label[text()='Last payment']/preceding::input[@class='ng-untouched ng-pristine ng-valid'])[4]"))
				.getAttribute("value");
	...
	public void user_verify_Analytics_pricing_Service_populated_as(String arg1) throws Throwable {
		DriverManager.getDriver()
				.findElement(By.xpath("//mat-select[@id='mat-select-6']/child::div['mat-select-trigger']")).getText();
	...
	public void user_verify_Analytics_Cashflow_From_populated_as(String arg1) throws Throwable {
		DriverManager.getDriver()
				.findElement(
						By.xpath("//mat-select[@formcontrolname='cashflowFromStart']/child::div['mat-select-trigger']"))
				.getText();
	...
	public void user_verify_Analytics_Valuation_Date_populated_as(String arg1) throws Throwable {
		DriverManager.getDriver()
				.findElement(By
						.xpath("//*[text()='Valuation Date']/parent::*/parent::*/preceding-sibling::input[@aria-required='false']"))
				.sendKeys("05/17/2018");
		valuationdate.click();
	...
	public static void enterinNewMoneyAmount(String NewMoneyAmount) {
		DriverManager.getDriver()
				.findElement(By.xpath("//*[text()='New money amount']//parent::*//parent::*/preceding-sibling::*"))
				.sendKeys("50000");
	}
	...
	public static void clickonWired(String Wired) {
		DriverManager.getDriver()
				.findElement(By
						.xpath("//mat-label[text()='Wired Amount']/parent::label/parent::span/preceding-sibling::input"))
				.click();
	}
	...
	public void clickAddoption() {
		...
		WebElement fileUploaded = DriverManager.getDriver()
				.findElement(By.xpath("(//div[@col-id ='documentName'])[2]"));
